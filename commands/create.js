 ...
 * @Last Modified by: 满楼
 * @Last Modified time: 2018-10-11 15:44:10
 * 添加路由文件
 */
...
module.exports = prompt(question).then(({ name, template, isdb }) => {
    ...
    //                 await createComponent(); //创建components文件夹
    //             } catch (err) {
